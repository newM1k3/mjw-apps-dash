...
const tiers = [
  {
    ...
    features: [
      'Flow — puzzle flow visualizer',
      'Playbook — marketing playbook generator',
      'Audit — marketing audit',
      'Geo & Roast — visibility and website teardowns',
  ...
  },
  {
    ...
    features: [
      'Everything in Free',
      'Locks — lock mapping studio',
      'Logic — puzzle dependency auditor',
      'Create — AI escape room generator',
      'Ready — room operations',
      'Scripts — GM script library',
      'Reviews — review scorecard',
      'Campaigns — seasonal campaign builder',
  ...
  },
  {
    ...
    features: [
      'Everything in Pro',
      'Layout — room layout risk mapper',
      'Blueprint — production bible builder',
      'Profit — party profit planner',
      'Pitch — corporate proposal generator',
      'Content — copy critique',
      'Priority support',
      'Team accounts',
    ],

...
- Demo-data affordance: none — app requires sign-in before any dashboard content renders; unauthenticated root shows the signup form
- Destinations (in order): Signup ("Create your ImmersiveKit account") → Login ("Sign in to access your tools"). No nav bar reachable signed-out; the rest of the dashboard is behind auth.
